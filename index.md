...
Developer built the "Land of Monsters" app as an Ad Supported app. This app is provided by at no cost and is intended for use as is.
...
2.0) Information that the developer collects
The developer collects the user's email if he wants to keep the progress.
...
UnityAds, is Google's mobile app advertising platform designed specifically for app
...
Each user can set an arbitrary nickname (player’s nickname), therefore the developer is not responsible for the nickname set by the player
